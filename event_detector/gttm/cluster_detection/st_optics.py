...
class OPTICS(BaseEstimator, ClusterMixin):
    """Estimate cluster_detection structure from vector array
    ...
    --------
    DBSCAN
        A similar cluster_detection for a specified neighborhood radius (eps).
        Our implementation is optimized for runtime.
    References
    ----------
    .. [1] Ankerst, Mihael, Markus M. Breunig, Hans-Peter Kriegel,
       and Jörg Sander. "OPTICS: ordering points to identify the cluster_detection
    ...
    def fit(self, X, y=None):
        """Perform OPTICS cluster_detection
        Extracts an ordered list of points and reachability distances, and
        performs initial cluster_detection using `max_eps` distance specified at
